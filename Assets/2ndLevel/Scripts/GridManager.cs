...
public class GridManager : MonoBehaviour
{
    ...
    public int Score4
    {
        ...
        {
            _score4 = value;
            Score4Text.text = _score4.ToString();
        }
    }
    private int _score5;
    public int Score5
    {
        ...
        {
            _score5 = value;
            Score5Text.text = _score5.ToString();
        }
    }
    private int _score6;
    public int Score6
    {
        ...
        {
            _score6 = value;
            Score6Text.text = _score6.ToString();
        }
    }
    ...
    public void SwapTiles(Vector2Int tile1Position, Vector2Int tile2Position)
    {
        ...
        if(!changesOccurs)
        {
            ...
            renderer1.sprite = renderer2.sprite;
            renderer2.sprite = temp;
            SsoundManager.Instance.PlaySound(SoundType.TypeMove);
        }
        else
        {
            SsoundManager.Instance.PlaySound(SoundType.TypePop);
            NumMoves--;
            do
            {
                FillHoles();
    ...
    bool CheckMatches()
    {
        ...
        Debug.Log("This is a log"+ matchedTiles);


        foreach (SpriteRenderer renderer in matchedTiles)
        {
            switch (renderer.sprite.name.ToString())
            {
    ...
    void GameOver()
    {
        ...
        SsoundManager.Instance.PlaySound(SoundType.TypeGameOver);
    }
}
